...
const SpeechLearningApp = () => {
  ...
  }, [selectedLevel, currentQuestion, autoListenEnabled, questions]);
  ...
  }, [selectedLevel, currentQuestion, speakQuestion]);
  ...
  const processVoiceInput = () => {
    ...
    if (success) {
      ...
      if (newAttempts >= 5) {
        ...
        const tryAgainMessage = `Try again! You have ${
          5 - newAttempts
        } attempts left.`;
        ...
        <div className="game-view">
          ...
          <div className="question-container">
            <div className="question-counter">
              ...
              {questions[selectedLevel]?.length}
            </div>
